...
// 1. Dar de alta una Publicación(POST) enviar al Empleado 
// como propiedad.
...
// 2. Recuperar TODAS las publicaciones (GET) incluyendo 
...
// 3. Eliminar una publicación(DELETE)
...
// 4. Modificar una publicación. (PUT)
...
// 5. Recuperar TODAS las Publicaciones basándose en una
// búsqueda combinada de los siguientes parámetros,
// Puede mandar los parámetros como GET(params) o
//POST
